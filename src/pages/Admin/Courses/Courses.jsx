...
import { courseInputData } from "../../../utils";
...
export function Courses() {
  ...
  useEffect(() => {
    getFetch("course", {
      ...
      .then((res) => {
        setCourseData(res.results.reverse());
        setIsLoading(false);
      })
      .catch((err) => {
  ...
  return (
    <>
      <h1 className="text-4xl text-white font-bold mb-8 capitalize">Kurslar</h1>
      ...
      {isOpen ? (
        <div className="fixed inset-0 flex items-center justify-center bg-black/50 backdrop-blur-sm z-50">
          <Modal
            ...
            buttonIcon={<HiPlus />}
            promoHeaderTitle="kurs qo'shish"
          />
        </div>
      ) : (
        []
      ...
      {isEditOpen ? (
        <div className="fixed inset-0 flex items-center justify-center bg-black/50 backdrop-blur-sm z-50">
          <Modal
            ...
            buttonIcon={<HiPlus />}
            promoHeaderTitle="kursni tahrirlash"
          />
        </div>
      ) : (
        []
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black/50 backdrop-blur-sm z-50">
          <div className="bg-gray-700 p-4 rounded-lg flex flex-col gap-y-6">
            <h2 className="text-white text-2xl">
              Siz haqiqatdan ham kursni o&apos;chirmoqchimisiz?
            </h2>
